...
public class AntiqueAtlasConfig implements ConfigObject {
    //============ Gameplay settings ==============
    @UnionConfig.Entry(group = "Gameplay", name = "doSaveBrowsingPos", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "Gameplay", name = "autoDeathMarker", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "Gameplay", name = "autoVillageMarkers", side = ConfigSide.Shared)
    @UnionConfig.Comment(comment = {"Whether to add global markers for NPC villages."})
    public boolean autoVillageMarkers = false;

    @UnionConfig.Entry(group = "Gameplay", name = "autoNetherPortalMarkers", side = ConfigSide.Shared)
    @UnionConfig.Comment(comment = {"Whether to add global markers for Nether Portals."})
    public boolean autoNetherPortalMarkers = true;

    @UnionConfig.Entry(group = "Gameplay", name = "itemNeeded", side = ConfigSide.Shared)
    @UnionConfig.Comment(comment = {"Player will need to craft atlas item to use atlas."})
    public boolean itemNeeded = true;

    //============ Interface settings =============
    @UnionConfig.Entry(group = "User Interface", name = "doScaleMarkers", side = ConfigSide.Shared)
    public boolean doScaleMarkers = false;

    @UnionConfig.Entry(group = "User Interface", name = "defaultScale", side = ConfigSide.Shared)
...
//    @UnionConfig.Entry(group = "userInterface", name = "minScale", side = ConfigSide.Shared)
...
//    @UnionConfig.Entry(group = "userInterface", name = "maxScale", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "User Interface", name = "doReverseWheelZoom", side = ConfigSide.Shared)
...
//    @UnionConfig.Entry(group = "performance", name = "scanRadius", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "performance", name = "forceChunkLoading", side = ConfigSide.Shared)
...
//    @UnionConfig.Entry(group = "performance", name = "newScanInterval", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "performance", name = "doRescan", side = ConfigSide.Shared)
...
//    @UnionConfig.Entry(group = "performance", name = "rescanRate", side = ConfigSide.Shared)
...
//    @UnionConfig.Entry(group = "performance", name = "markerLimit", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "performance", name = "doScanPonds", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "performance", name = "doScanRavines", side = ConfigSide.Shared)
    @UnionConfig.Comment(comment = {"Whether to perform additional scanning to locate ravines.\nDisable for better performance."})
    public boolean doScanRavines = true;

    @UnionConfig.Entry(group = "performance", name = "debugRender", side = ConfigSide.Shared)
    @UnionConfig.Comment(comment = {"If true, map render time will be output."})
    public boolean debugRender = false;

    @UnionConfig.Entry(group = "performance", name = "resourcePackLogging", side = ConfigSide.Shared)
    ...
    @UnionConfig.Entry(group = "appearance", name = "tileSize", side = ConfigSide.Shared)
...
//    @UnionConfig.Entry(group = "appearance", name = "markerSize", side = ConfigSide.Shared)
...
//    @UnionConfig.Entry(group = "appearance", name = "playerIconWidth", side = ConfigSide.Shared)
    @UnionConfig.Comment(comment = {"The width (in GUI pixels) of the player's icon."})
    //@Setting.Constrain.Range(min = 0)
    public int playerIconWidth = 14;

//    @UnionConfig.Entry(group = "appearance", name = "playerIconHeight", side = ConfigSide.Shared)
