...
public class MarkerType {
	public static final ResourceKey<Registry<MarkerType>> KEY = ResourceKey.createRegistryKey(AntiqueAtlas.id("marker"));
	public static final net.minecraft.core.DefaultedMappedRegistry<MarkerType> REGISTRY = new net.minecraft.core.DefaultedMappedRegistry<>(AntiqueAtlas.id("red_x_small").toString(),
			KEY,
...
//			REGISTRY.registerOrOverride(OptionalInt.of(id), ResourceKey.create(KEY, location), type, Lifecycle.stable());
	...
	public ResourceLocation getIcon() {
		return icons.length == 0 || iconIndex < 0 ? TextureManager.INTENTIONAL_MISSING_TEXTURE : icons[iconIndex];
	}
