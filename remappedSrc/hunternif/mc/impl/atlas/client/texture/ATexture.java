...
public abstract class ATexture implements ITexture {
    ...
    public void drawCenteredWithRotation(PoseStack matrices, int x, int y, int width, int height, float rotation) {
        matrices.pushPose();
        matrices.translate(x, y, 0);
        matrices.mulPose(Vector3f.ZP.rotationDegrees(180 + rotation));
