...
public class TileTextureMap {
    ...
    @ExpectPlatform
    static private Optional<ResourceLocation> guessFittingTextureSet(ResourceKey<Biome> biome) {
    ...
    static public Optional<ResourceLocation> guessFittingTextureSetFallback(Biome biome) {
        ResourceLocation texture_set = switch (biome.getBiomeCategory()) {
            ...
            case THEEND -> {
                ...
                PlacedFeature chorus_plant_feature = BuiltinRegistries.PLACED_FEATURE.get(new ResourceLocation("chorus_plant"));
