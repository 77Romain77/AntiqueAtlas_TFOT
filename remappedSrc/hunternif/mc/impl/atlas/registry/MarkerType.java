...
public class MarkerType {
	...
	public static final net.minecraft.core.DefaultedRegistry<MarkerType> REGISTRY = new net.minecraft.core.DefaultedRegistry<>(AntiqueAtlasMod.id("red_x_small").toString(),
			KEY,
